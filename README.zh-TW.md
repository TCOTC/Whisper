...
> **前置要求**：主題的預設配色與特性已內建，無需外掛即可使用。伴生外掛 [Whisper-Plus](https://github.com/TCOTC/Whisper-Plus) 提供切換配色與特性的設定選單以及匿名統計資訊，建議安裝以獲得完整體驗。
...
這些資訊有助於改進主題品質。所有資料均為匿名收集，不會包含任何個人隱私資訊。

首次安裝主題之後的一天內不會收集資訊，您可以在「淺吟增強」外掛的設定選單中停用匿名統計資訊功能。